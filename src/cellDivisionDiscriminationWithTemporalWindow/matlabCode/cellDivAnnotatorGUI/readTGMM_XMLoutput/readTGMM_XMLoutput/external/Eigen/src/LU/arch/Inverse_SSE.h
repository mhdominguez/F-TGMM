...
struct compute_inverse_size4<Architecture::SSE, double, MatrixType, ResultType>
{
  ...
  static void run(const MatrixType& matrix, ResultType& result)
  {
    ...
    const EIGEN_ALIGN16 long long long int _Sign_NP[2] = { 0x8000000000000000ll, 0x0000000000000000ll };
    const EIGEN_ALIGN16 long long long int _Sign_PN[2] = { 0x0000000000000000ll, 0x8000000000000000ll };
#else
    const EIGEN_ALIGN16 __int128_t _Sign_NP[2] = { 0x8000000000000000ll, 0x0000000000000000ll };
    const EIGEN_ALIGN16 __int128_t _Sign_PN[2] = { 0x0000000000000000ll, 0x8000000000000000ll };
#endif
    // The inverse is calculated using "Divide and Conquer" technique. The
    // original matrix is divide into four 2x2 sub-matrices. Since each
