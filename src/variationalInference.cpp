...
//==========================================================================================================
void updateGaussianParameters(mylib::Array *img, vector<GaussianMixtureModel*> &vecGM, responsibilities &r, bool regularize_W)
{
	...
	for(unsigned int kk=0;kk<K;kk++)
	{
		if(vecGM[kk]->isDead()==false)
		{
			...
			vecGM[kk]->regularizePrecisionMatrix(regularize_W);
		}
	}
