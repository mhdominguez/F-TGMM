...
int main( int argc, const char** argv )
{
	...
	cout<<"Training classifier for cell division discrimination using temporal window of features"<<endl;
	...
	if(argc == 4)
	{
		...
		J = atoi( argv[2] );
		symmetryN = atoi( argv[3] );//calculate features for this image using all possible 8 combinations of eigenvectors directions to artifically increment the traning data	
	}else if(argc == 1){
